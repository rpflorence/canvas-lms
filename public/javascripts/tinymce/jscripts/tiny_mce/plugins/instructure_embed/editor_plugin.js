...
require([
  ...
  var TRANSLATIONS = {
    ...
    instructions: htmlEscape(I18n.t('instructions', "Paste or type the URL of the image you'd like to embed:")),
    url: htmlEscape(I18n.t('url', 'URL:')),
    alt_text: htmlEscape(I18n.t('alt_text', 'Alternate Text:')),
    ...
    embed_image: htmlEscape(I18n.t('embed_image', 'Embed Image')),
  ...
  function embedURLImage (event) {
    var alt = htmlEscape($altText.val() || ''),
        text = htmlEscape($userURL.val());
